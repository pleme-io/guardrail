  ...
  internal = rec {
    ...
    crates = {
      ...
      "assert_cmd" = rec {
        ...
        edition = "2024";
        crateBin = [];
        sha256 = "1jcrxj9bhj2n18id6ial1r3mz4jdwwvb4886vy18mf7gwnz6ns4s";
        authors = [
      ...
      "hayai" = rec {
        ...
        version = "0.1.1";
        edition = "2024";
        sha256 = "122z4d8va3j41l734cwf2zbvjn6f4svr4p886vfks3fbji01n654";
        dependencies = [
          {
            name = "regex";
            packageId = "regex";
      ...
      "predicates" = rec {
        ...
        resolvedDefaultFeatures = [ "color" "default" "diff" "float-cmp" "normalize-line-endings" "regex" ];
      };
      "predicates-core" = rec {
